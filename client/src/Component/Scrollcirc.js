  ...
  return (
    <div className="scroll-container">
      <div className="background-section">
        ...
        <div className={`element left-element ${scrollY > 240 ? 'visible' : ''}`}>
        ...
        <div className={`element left-element ${scrollY > 260 ? 'visible' : ''}`}>
        ...
        <div className={`element right-element ${scrollY > 280 ? 'visible' : ''}`}>
        ...
        <div className={`element right-element ${scrollY > 290 ? 'visible' : ''}`}>
